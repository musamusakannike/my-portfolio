      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: monospace; background-color: #0a0a0a; color: #fff; padding: 40px; border: 1px solid #333; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #adff2f; border-bottom: 1px solid #333; padding-bottom: 20px; font-weight: 800; letter-spacing: -1px; text-transform: uppercase; margin-top: 0;">CODIAC // CONFIRM SUBSCRIPTION</h2>
            ...
            <div style="margin: 32px 0;">
              <a href="${confirmUrl}" style="background-color: #adff2f; color: #0a0a0a; text-decoration: none; padding: 12px 24px; font-weight: bold; font-size: 14px; border-radius: 0; display: inline-block; border: 1px solid #adff2f;">CONFIRM SUBSCRIPTION</a>
            </div>
