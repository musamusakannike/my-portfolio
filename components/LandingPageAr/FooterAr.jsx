...
const FooterAr = () => {
  ...
  return (
    <footer className="bg-[#050505] border-t border-white/10 pt-16 pb-8 font-cairo relative overflow-hidden">
      {/* Scanlines generic */}
      ...
      <div className="container mx-auto px-6 relative z-10 font-cairo">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <Link
              href="/ar"
              className="text-2xl font-black text-white tracking-tighter mb-4 block font-el-messiri"
            >
          ...
          <div className="col-span-1">
            <h4 className="text-white font-bold mb-4 text-sm font-el-messiri">التنقل</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600">
          <p>
            SYSTEM_STATUS: <span className="text-green-500">متصل</span>
          </p>
