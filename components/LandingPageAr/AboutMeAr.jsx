...
const traits = [
  {
    label: "كود نظيف",
    desc: "أكتب كودًا قابلاً للقراءة والصيانة مع التركيز على القابلية للتطوير على المدى الطويل.",
    icon: (
  ...
  {
    label: "تطوير متكامل",
    desc: "مرتاح في كل طبقة — من تصميم قواعد البيانات إلى واجهة المستخدم المثالية.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    label: "سريع التعلم",
    desc: "أتعلم المكدسات والأنماط الجديدة بسرعة، وأزدهر في البيئات المتطورة.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    label: "متعاون ومبادر",
    desc: "متواصل قوي يستمتع بالبرمجة الثنائية، ومراجعة الكود، وحل المشكلات الجماعية.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export default function AboutMeAr() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".about-divider", {
        scaleX: 0, transformOrigin: "right center", duration: 1.0, ease: "power3.out",
  ...
  return (
    <section ref={sectionRef} id="about" className="about-section">
      ...
      {/* Three.js canvas — positioned left side for RTL */}
      ...
      <div className="about-container">
        ...
        <div className="about-left">
          ...
          {/* Heading */}
          <h2 className="about-heading font-el-messiri">
            تحويل الأفكار<br />
            إلى <em>منتجات حقيقية</em>
          </h2>
          ...
          <div className="about-bio">
            <p>
              أنا <strong>موسى موسى كانيكي</strong>، مطور متكامل وشغوف ببناء منتجات قوية بقدر ما هي جميلة وجذابة على السطح. أعمل عبر المكدس الكامل — في صياغة واجهات أمامية متجاوبة، وبناء واجهات برمجية APIs قوية، وكل شيء بينهما.
            </p>
            <p>
              مع أكثر من 5 سنوات من الخبرة، قمت بتسليم أكثر من 30 مشروعًا تتراوح من الشركات الناشئة الجديدة إلى الأنظمة المؤسسية المعقدة. أهتم بشدة بجودة الكود وتجربة المطورين وتسليم أعمال تعمل بشكل حقيقي.
            </p>
          </div>
          ...
          >
            <FaDownload />
            <span className="font-cairo">تحميل السيرة الذاتية</span>
          </a>
          ...
          <div className="traits-grid">
            {traits.map((t) => (
              <div key={t.label} className="trait-card">
                ...
                <div>
                  <div className="trait-label font-el-messiri">{t.label}</div>
        ...
        {/* ── Left column — placeholder for canvas + skills ── */}
        <div className="about-right">
          {/* Skills */}
          <div className="skills-panel">
            <div className="skills-label eyebrow font-el-messiri">
