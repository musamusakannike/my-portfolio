  ...
  return (
    <section className="hero">
      ...
      <nav className={`nav ${navScrolled ? "scrolled" : ""}`}>
        <div className="logo font-el-messiri">كودياك</div>
        <div className="navRight">
          <a href="#projects">
            <button className="btnGhost" type="button">أعمالي</button>
          </a>
          <a href="#contact">
            <button className="btnPrimary" type="button">توظيفي</button>
          </a>
          <a href="/?locale=en">
            <button className="btnGhost" type="button" style={{ border: "1px solid rgba(255,255,255,0.2)", borderRadius: "100px", padding: "10px 14px" }}>EN</button>
          </a>
        </div>
      </nav>
      ...
      <div className="heroContent">
        <div className="heroLeft">
          {/* Headline */}
          <h1 id={ids.headline} className="headline font-el-messiri">
            موسى<span className="mobileHide"><br /></span> موسى<br />
            <em>كانيكي</em>
          </h1>

          {/* Sub */}
          <p id={ids.sub} className="heroSub text-white text-shadow-md">
            مطور متكامل أصنع منتجات أنيقة — من الواجهات المثالية للبكسل إلى خوادم قوية وقابلة للتطوير.
          </p>
          ...
          <div id={ids.stats} className="heroStats">
            <div className="statItem">
              <span className="statNum font-amiri">+5</span>
              <span className="statLbl">سنوات الخبرة</span>
            </div>
            <div className="statSep" />
            <div className="statItem">
              <span className="statNum font-amiri">+30</span>
              <span className="statLbl">مشاريع منجزة</span>
            </div>
            <div className="statSep" />
            <div className="statItem">
              <span className="statNum font-amiri">+12</span>
              <span className="statLbl">عملاء سعداء</span>
            </div>
          </div>
        </div>
      ...
      <div id={ids.bottomBar} className="bottomBar">
        {[
          { label: "الرئيسية", id: "home",     icon: "M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z" },
          { label: "عنّي",     id: "about",    icon: "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2M12 11a4 4 0 100-8 4 4 0 000 8z" },
          { label: "المشاريع", id: "projects", icon: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z" },
          { label: "اتصل بي", id: "contact",  icon: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zM22 6l-10 7L2 6" },
        ].map((item, i) => (
          <a key={item.id} href={`#${item.id}`} className={`barItem${i === 0 ? " barHome" : ""}`}>
      ...
      <style jsx>{`
        ...
        .ctaBtn svg {
          ...
          flex-shrink: 0;
          transform: scaleX(-1); /* Flips the arrow for RTL */
        }
        ...
        .statNum {
          font-family: var(--font-amiri), system-ui, sans-serif;
          font-size: 28px;
          font-weight: 700;
          color: #fff;
          line-height: 1;
